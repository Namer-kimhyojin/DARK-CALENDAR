...
- Release page for `3.7.5`: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/tag/v3.7.5>
- Complete corresponding-source archive: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/download/v3.7.5/DarkCalendar-3.7.5-corresponding-source.zip>
