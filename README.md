...
- Release page for `3.7.6`: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/tag/v3.7.6>
- Complete corresponding-source archive: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/download/v3.7.6/DarkCalendar-3.7.6-corresponding-source.zip>
