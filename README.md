...
- Release page for `3.7.3`: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/tag/v3.7.3>
- Complete corresponding-source archive: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/download/v3.7.3/DarkCalendar-3.7.3-corresponding-source.zip>
