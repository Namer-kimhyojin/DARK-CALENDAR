...
- Release page for `3.7.4`: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/tag/v3.7.4>
- Complete corresponding-source archive: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/download/v3.7.4/DarkCalendar-3.7.4-corresponding-source.zip>
