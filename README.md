...
- Release page for `3.6.8`: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/tag/v3.6.8>
- Complete corresponding-source archive: <https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/download/v3.6.8/DarkCalendar-3.6.8-corresponding-source.zip>
