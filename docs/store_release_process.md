...
```bat
build-release.bat -ValidateOnly -Version 3.7.5 -PackageVersion 3.7.5.0 -ReleaseDate 2026-09-17 -Channel Stable
```
...
- `release\store\DarkCalendar-3.7.5.0-arm64_x64.msixupload`

If only one native package is available, the scripts fall back to:

- `release\store\DarkCalendar-3.7.5.0-x64.msixupload`
- `release\store\DarkCalendar-3.7.5.0-arm64.msixupload`
...
- `release\source\DarkCalendar-3.7.5-corresponding-source.zip`
