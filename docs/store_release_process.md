...
```bat
build-release.bat -ValidateOnly -Version 3.7.6 -PackageVersion 3.7.6.0 -ReleaseDate 2026-09-18 -Channel Stable
```
...
- `release\store\DarkCalendar-3.7.6.0-arm64_x64.msixupload`

If only one native package is available, the scripts fall back to:

- `release\store\DarkCalendar-3.7.6.0-x64.msixupload`
- `release\store\DarkCalendar-3.7.6.0-arm64.msixupload`
...
- `release\source\DarkCalendar-3.7.6-corresponding-source.zip`
