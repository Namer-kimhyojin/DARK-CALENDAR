...
```bat
build-release.bat -ValidateOnly -Version 3.6.8 -PackageVersion 3.6.8.0 -ReleaseDate 2026-09-15 -Channel Stable
```
...
- `release\store\DarkCalendar-3.6.8.0-arm64_x64.msixupload`

If only one native package is available, the scripts fall back to:

- `release\store\DarkCalendar-3.6.8.0-x64.msixupload`
- `release\store\DarkCalendar-3.6.8.0-arm64.msixupload`
...
- `release\source\DarkCalendar-3.6.8-corresponding-source.zip`
