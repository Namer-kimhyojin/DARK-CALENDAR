(function () {
  ...
  const fallbackConfig = {
    ...
    releaseSourceUrl: "https://github.com/Namer-kimhyojin/DARK-CALENDAR/releases/tag/v3.7.5",
    licenseUrl: "https://github.com/Namer-kimhyojin/DARK-CALENDAR/blob/v3.7.5/LICENSE",
    thirdPartyNoticesUrl: "https://github.com/Namer-kimhyojin/DARK-CALENDAR/blob/v3.7.5/THIRD_PARTY_NOTICES.md",
  ...
  const translations = {
    ko: {
      metaTitle: "Air Calendar | 일정과 할 일을 바탕화면 한 곳에",
      ...
      floatToday: "오늘", floatFocus: "집중 세션", heroVisualLabel: "Air Calendar 제품 화면 미리보기",
      screenMainAlt: "Air Calendar 월간 캘린더와 업무 패널 화면",
      ...
      faqOneQ: "어떤 운영체제를 지원하나요?", faqOneA: "Air Calendar는 Windows 데스크톱 환경에 맞춰 설계되었습니다. 정확한 최신 요구 사항은 Microsoft Store 제품 페이지에서 확인할 수 있습니다.",
    ...
    en: {
      metaTitle: "Air Calendar | Your day, all in one desktop view",
      ...
      floatToday: "Today", floatFocus: "Focus session", heroVisualLabel: "Air Calendar product preview",
      screenMainAlt: "Air Calendar monthly calendar with task panels",
      ...
      faqOneQ: "Which operating systems are supported?", faqOneA: "Air Calendar is designed for Windows desktop. Check the Microsoft Store product page for the latest exact system requirements.",
    ...
    ja: {
      metaTitle: "Air Calendar | 予定とタスクをデスクトップの一か所に",
      ...
      floatToday: "今日", floatFocus: "集中セッション", heroVisualLabel: "Air Calendar 製品画面プレビュー",
      screenMainAlt: "Air Calendarの月間カレンダーとタスクパネル",
      ...
      faqOneQ: "対応OSは？", faqOneA: "Air CalendarはWindowsデスクトップ向けです。最新の正確な要件はMicrosoft Store製品ページで確認できます。",
    ...
    zh: {
      metaTitle: "Air Calendar | 在桌面一处管理日程与任务",
      ...
      floatToday: "今天", floatFocus: "专注时段", heroVisualLabel: "Air Calendar 产品界面预览",
      screenMainAlt: "Air Calendar 月历与任务面板界面",
      ...
      faqOneQ: "支持哪些操作系统？", faqOneA: "Air Calendar 专为 Windows 桌面环境设计。最新准确要求请查看 Microsoft Store 产品页面。",
  ...
  const expandedTranslations = {
    ko: {
      navGoogle: "Google 연동",
      metaDescription: "캘린더와 위젯을 바탕화면에 직접 배치하고, 크기·위치·레이아웃·색상을 자유롭게 구성하는 맞춤형 Windows 데스크톱 캘린더 Air Calendar.",
      ...
      desktopLead: "Air Calendar의 가장 큰 장점은 필요한 기능을 바탕화면에 직접 구현하는 것입니다. 정해진 틀에 맞추는 대신, 사용자가 자신의 화면과 업무 방식에 맞춰 공간을 설계합니다.",
      ...
      googleLead: "연동은 선택 기능입니다. 한 번만 Google Cloud에서 데스크톱용 인증 파일을 준비하면, 이후에는 Air Calendar 안에서 캘린더를 선택하고 동기화할 수 있습니다.",
      ...
      googleStepFourWarning: "Web application 유형은 Air Calendar에서 동작하지 않습니다.",
      googleStepFiveTitle: "Air Calendar에서 인증하기", googleStepFiveBody: "설정 → Calendar & Sync → 연결에서 ‘Google Calendar 동기화 사용’을 켜고 JSON 파일을 선택한 뒤 ‘인증’을 누릅니다. 브라우저가 열리면 계정을 선택하고 권한을 허용합니다.",
      ...
      syncPullTitle: "Google 일정을 가져옵니다.", syncPullBody: "제목, 날짜·시간, 종일 일정, 설명, 장소, 색상과 반복 일정 정보를 Air Calendar에서 함께 볼 수 있습니다.",
      syncPushTitle: "내 변경 사항을 보냅니다.", syncPushBody: "Air Calendar에서 만든 일정과 수정한 시간·내용이 선택한 Google 캘린더에 반영됩니다.",
      ...
      shareTitle: "바탕화면을 더 잘 쓰고 싶은 사람에게<br><em>Air Calendar를 알려주세요.</em>",
      shareBody: "일정과 위젯을 자기 방식대로 배치하고 싶은 친구나 동료에게 이 페이지를 공유해 주세요.",
      shareActionsLabel: "Air Calendar 공유 방법", shareX: "X에 공유", shareFacebook: "Facebook", shareLinkedIn: "LinkedIn", shareEmail: "이메일", shareCopy: "링크 복사", shareCopied: "링크를 복사했습니다.", shareFailed: "주소창의 링크를 복사해 주세요.",
      shareText: "캘린더와 위젯을 바탕화면에 직접 배치하고, 위치·크기·레이아웃·색상까지 내 방식대로 만드는 Windows 앱, Air Calendar.", shareKit: "공식 홍보자료 내려받기", footerPromotion: "홍보 자료"
    },
    en: {
      navGoogle: "Google sync",
      metaDescription: "Air Calendar is a customizable Windows desktop calendar that lets you place, move, resize, recolor, and arrange calendars and widgets directly on your desktop.",
      ...
      desktopLead: "Air Calendar’s defining advantage is bringing the tools you need directly onto the desktop. Instead of adapting to a fixed frame, you design the space around your screen and workflow.",
      ...
      googleLead: "Sync is optional. Prepare a desktop credential file in Google Cloud once, then choose and sync calendars from inside Air Calendar.",
      ...
      googleStepFourWarning: "The Web application type does not work with Air Calendar.",
      googleStepFiveTitle: "Authorize in Air Calendar", googleStepFiveBody: "Open Settings → Calendar & Sync → Connection, enable Google Calendar sync, choose the JSON file, and select Authenticate. In the browser, choose your account and allow access.",
      ...
      syncPullTitle: "Bring Google events in.", syncPullBody: "View titles, dates and times, all-day events, descriptions, locations, colors, and recurring events in Air Calendar.",
      syncPushTitle: "Send your changes out.", syncPushBody: "Events created in Air Calendar and edits to their time or content are reflected in the selected Google calendar.",
      ...
      shareTitle: "Know someone who wants a better desktop?<br><em>Share Air Calendar.</em>",
      shareBody: "Send this page to a friend or teammate who wants calendars and widgets arranged around the way they work.",
      shareActionsLabel: "Ways to share Air Calendar", shareX: "Share on X", shareFacebook: "Facebook", shareLinkedIn: "LinkedIn", shareEmail: "Email", shareCopy: "Copy link", shareCopied: "Link copied.", shareFailed: "Please copy the link from the address bar.",
      shareText: "Air Calendar is a Windows app that puts calendars and widgets directly on your desktop—with freely adjustable position, size, layout, and color.", shareKit: "Download the official media kit", footerPromotion: "Promotion kit"
    },
    ja: {
      navGoogle: "Google連携",
      metaDescription: "カレンダーとウィジェットをデスクトップに直接配置し、サイズ・位置・レイアウト・色を自由に調整できるWindows用カスタムカレンダー、Air Calendar。",
      ...
      desktopLead: "Air Calendar最大の魅力は、必要な機能をデスクトップに直接実装できることです。決められた枠ではなく、画面と仕事の流れに合わせて空間を設計できます。",
      ...
      googleLead: "連携は任意です。Google Cloudでデスクトップ用認証ファイルを一度準備すれば、その後はAir Calendar内でカレンダーを選んで同期できます。",
      ...
      googleStepFourWarning: "Web application種類はAir Calendarでは動作しません。",
      googleStepFiveTitle: "Air Calendarで認証", googleStepFiveBody: "設定→Calendar & Sync→接続で同期を有効にし、JSONを選んで「認証」を押します。ブラウザでアカウントを選び、アクセスを許可します。",
      googleStepSixTitle: "選択・テスト・保存", googleStepSixBody: "一覧から使うカレンダーを選び、「カレンダーアクセスのテスト」を実行します。成功を確認して設定を保存すれば完了です。",
      syncPullTitle: "Google予定を取り込みます。", syncPullBody: "タイトル、日時、終日予定、説明、場所、色、繰り返し予定をAir Calendarで確認できます。",
      syncPushTitle: "変更内容をGoogleへ送ります。", syncPushBody: "Air Calendarで作成した予定や変更した時刻・内容が選択中のGoogleカレンダーへ反映されます。",
      ...
      shareTitle: "デスクトップをもっと活用したい人へ<br><em>Air Calendarを紹介してください。</em>",
      shareBody: "カレンダーやウィジェットを自分らしく配置したい友人や同僚に、このページを共有してください。",
      shareActionsLabel: "Air Calendarの共有方法", shareX: "Xで共有", shareFacebook: "Facebook", shareLinkedIn: "LinkedIn", shareEmail: "メール", shareCopy: "リンクをコピー", shareCopied: "リンクをコピーしました。", shareFailed: "アドレスバーのリンクをコピーしてください。",
      shareText: "カレンダーとウィジェットをデスクトップに直接置き、位置・サイズ・レイアウト・色まで自由に整えられるWindowsアプリ、Air Calendar。", shareKit: "公式プロモーション素材を入手", footerPromotion: "プロモーション資料"
    },
    zh: {
      navGoogle: "Google 同步",
      metaDescription: "Air Calendar 是一款可自定义的 Windows 桌面日历，可将日历与小组件直接放在桌面并自由调整大小、位置、布局和颜色。",
      ...
      desktopLead: "Air Calendar最大的优势，是把需要的功能直接实现于桌面。无需适应固定框架，你可以围绕自己的屏幕与工作流程设计空间。",
      ...
      googleLead: "同步是可选功能。只需在Google Cloud准备一次桌面凭据文件，之后便可在Air Calendar中选择并同步日历。",
      ...
      googleStepFourWarning: "Web application 类型无法用于 Air Calendar。",
      googleStepFiveTitle: "在 Air Calendar 中授权", googleStepFiveBody: "打开设置→Calendar & Sync→连接，启用同步，选择JSON后点击“授权”。浏览器打开后选择帐号并允许访问。",
      googleStepSixTitle: "选择、测试并保存", googleStepSixBody: "从列表选择要用的日历并运行“日历访问测试”。看到成功消息后保存设置即可。",
      syncPullTitle: "导入 Google 日程。", syncPullBody: "可在Air Calendar中查看标题、日期与时间、全天事件、说明、地点、颜色和重复事件。",
      syncPushTitle: "发送你的更改。", syncPushBody: "在Air Calendar中新建的事件，以及对时间与内容的修改，会同步到所选Google日历。",
      ...
      shareTitle: "把 Air Calendar 分享给<br><em>想让桌面更高效的人。</em>",
      shareBody: "将此页面分享给希望按自己的方式排列日历和小组件的朋友或同事。",
      shareActionsLabel: "Air Calendar 分享方式", shareX: "分享到 X", shareFacebook: "Facebook", shareLinkedIn: "LinkedIn", shareEmail: "电子邮件", shareCopy: "复制链接", shareCopied: "链接已复制。", shareFailed: "请复制地址栏中的链接。",
      shareText: "Air Calendar 是一款 Windows 应用，可将日历和小组件直接放在桌面，并自由调整位置、大小、布局和颜色。", shareKit: "下载官方推广素材", footerPromotion: "推广资料"
    }
  };
  ...
  const screens = {
    ko: {
      ...
      widgets: { image: "assets/screenshots/widget-manager.png", alt: "Air Calendar 위젯 매니저 화면", kicker: "WIDGET MANAGER", title: "일곱 종류의 위젯을 원하는 만큼 배치하세요.", description: "보이기·숨기기·설정·위치 고정과 삭제를 한곳에서 관리합니다. 같은 종류의 위젯도 이름을 달리해 여러 개 만들 수 있습니다.", points: ["시계·날씨·스톱워치·날짜 카드", "카운트다운·D-Day·텍스트 템플릿", "멀티 인스턴스와 위치 저장"] },
      focus: { image: "assets/screenshots/focus-mode.png", alt: "Air Calendar 집중 모드 기록 화면", kicker: "FOCUS HISTORY", title: "집중한 시간도 일정처럼 기록됩니다.", description: "최근 집중 세션과 누적 시간을 확인하고, 작업을 선택해 Pomodoro 흐름으로 이어갈 수 있습니다.", points: ["작업 선택형 집중 세션", "오늘·이번 달 누적 시간", "세션 기록 확인과 정리"] },
      sync: { image: "assets/screenshots/calendar-sync-air-calendar.png", alt: "Air Calendar Google Calendar 동기화 설정 화면", kicker: "GOOGLE CALENDAR", title: "필요할 때만 연결하는 캘린더 동기화.", description: "연결, 캘린더 선택, 구독, 동기화, 진단을 단계별 탭으로 나누어 설정할 수 있습니다. 로컬 캘린더만으로도 사용할 수 있습니다.", points: ["선택형 Google Calendar 인증", "연결 테스트와 동기화 진단", "로컬·Google·ICS 캘린더 관리"] }
    },
    en: {
      main: { image: "assets/screenshots/main-dashboard.png", alt: "Air Calendar monthly calendar and task panels", kicker: "CALENDAR WORKSPACE", title: "Close the gap between planning and doing.", description: "Weekly schedules, routines, and directives sit beside the monthly calendar, so you can choose what to do from the same place you review the date.", points: ["Multi-day events and drag range selection", "Today and This Week panel views", "Separate routines and action items"] },
      widgets: { image: "assets/screenshots/widget-manager.png", alt: "Air Calendar Widget Manager", kicker: "WIDGET MANAGER", title: "Place seven types of widgets wherever you need them.", description: "Show, hide, configure, pin, and remove widgets from one manager. Create multiple named instances of the same widget type.", points: ["Clock, weather, stopwatch, and date card", "Countdown, D-Day, and text templates", "Multiple instances with saved positions"] },
      focus: { image: "assets/screenshots/focus-mode.png", alt: "Air Calendar focus session history", kicker: "FOCUS HISTORY", title: "Your focused time becomes part of the record.", description: "Review recent sessions and totals, then choose a task and continue into a Pomodoro-based focus flow.", points: ["Task-based focus sessions", "Daily and monthly totals", "Review and clean up session history"] },
      sync: { image: "assets/screenshots/calendar-sync-air-calendar.png", alt: "Air Calendar Google Calendar sync settings", kicker: "GOOGLE CALENDAR", title: "Calendar sync that connects only when you choose.", description: "Connection, calendars, subscriptions, sync, and diagnostics are arranged in guided tabs. The app also works with the local calendar alone.", points: ["Optional Google Calendar authorization", "Connection tests and sync diagnostics", "Local, Google, and ICS calendars"] }
    },
    ja: {
      main: { image: "assets/screenshots/main-dashboard.png", alt: "Air Calendarの月間カレンダーとタスクパネル", kicker: "CALENDAR WORKSPACE", title: "計画と実行の距離をなくしました。", description: "月間カレンダーの横に今週の予定、ルーティン、ディレクティブを表示。日付を確認した場所で次の行動を選べます。", points: ["複数日予定とドラッグ範囲選択", "今日・今週パネルの切り替え", "ルーティンと実行項目を分けて管理"] },
      widgets: { image: "assets/screenshots/widget-manager.png", alt: "Air Calendar ウィジェット管理画面", kicker: "WIDGET MANAGER", title: "7種類のウィジェットを好きなだけ配置。", description: "表示、非表示、設定、位置固定、削除を一か所で管理。同じ種類も名前を変えて複数作成できます。", points: ["時計・天気・ストップウォッチ・日付カード", "カウントダウン・D-Day・テキスト", "複数インスタンスと位置保存"] },
      focus: { image: "assets/screenshots/focus-mode.png", alt: "Air Calendar 集中モード履歴画面", kicker: "FOCUS HISTORY", title: "集中した時間も予定のように記録。", description: "最近の集中セッションと累計時間を確認し、タスクを選んでPomodoroの流れへ続けられます。", points: ["タスク選択型の集中セッション", "今日・今月の累計時間", "セッション履歴の確認と整理"] },
      sync: { image: "assets/screenshots/calendar-sync-air-calendar.png", alt: "Air Calendar Google Calendar同期設定", kicker: "GOOGLE CALENDAR", title: "必要なときだけつなぐカレンダー同期。", description: "接続、カレンダー選択、購読、同期、診断をタブごとに設定できます。ローカルカレンダーだけでも使用できます。", points: ["任意のGoogle Calendar認証", "接続テストと同期診断", "ローカル・Google・ICS管理"] }
    },
    zh: {
      main: { image: "assets/screenshots/main-dashboard.png", alt: "Air Calendar 月历与任务面板", kicker: "CALENDAR WORKSPACE", title: "缩短计划与执行之间的距离。", description: "月历旁就是本周日程、例行任务和指令。查看日期后，无需切换界面即可选择下一步。", points: ["多日事件与拖动范围选择", "今日与本周面板切换", "例行任务与执行项分开管理"] },
      widgets: { image: "assets/screenshots/widget-manager.png", alt: "Air Calendar 小组件管理器", kicker: "WIDGET MANAGER", title: "七类小组件，按需自由放置。", description: "在一处完成显示、隐藏、设置、锁定位置和删除。同一类型也可命名并创建多个实例。", points: ["时钟、天气、秒表和日期卡", "倒计时、D-Day 和文字模板", "多实例与位置保存"] },
      focus: { image: "assets/screenshots/focus-mode.png", alt: "Air Calendar 专注模式记录", kicker: "FOCUS HISTORY", title: "专注时间也会成为可回顾的记录。", description: "查看近期专注时段与累计时间，选择任务后继续进入 Pomodoro 专注流程。", points: ["基于任务的专注时段", "今日与本月累计时间", "查看并整理时段历史"] },
      sync: { image: "assets/screenshots/calendar-sync-air-calendar.png", alt: "Air Calendar Google Calendar 同步设置", kicker: "GOOGLE CALENDAR", title: "只在需要时连接日历同步。", description: "连接、日历选择、订阅、同步和诊断按步骤分成标签页。也可以仅使用本地日历。", points: ["可选 Google Calendar 授权", "连接测试与同步诊断", "本地、Google 与 ICS 日历管理"] }
    }
  };
