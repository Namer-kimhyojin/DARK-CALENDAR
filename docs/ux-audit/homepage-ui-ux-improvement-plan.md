...
Air Calendar 특유의 어두운 데스크톱 분위기와 제품 성격은 잘 드러납니다. 다만 현재는 제품 소개보다 이벤트 팝업이 먼저 나오고, 히어로의 제품 목업이 제목·설명·CTA와 겹치며, 모바일에서는 겹침이 더 심해집니다. 시각적 개성은 강하지만 구매·설치 전환을 위한 정보 우선순위와 반응형 안정성은 재정리가 필요합니다.
