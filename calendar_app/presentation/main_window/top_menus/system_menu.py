...
def build_system_menu(self, top_bar, menu_btn_style="", menu_style=""):
    ...
    set_themed_icon(self.sys_menu_btn, ICON.SETTINGS, icon_color)
    ...
    set_themed_icon(self.autostart_menu_act, ICON.AUTOSTART, icon_color)
    ...
    set_themed_icon(self.lang_menu, ICON.LOCALE_MGMT, icon_color)
    ...
    set_themed_icon(self.locale_tools_menu, ICON.LOCALE_MGMT, icon_color)
    ...
    set_themed_icon(act_source, ICON.GLOBE, icon_color)
