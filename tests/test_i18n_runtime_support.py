...
class I18nRuntimeSupportTests(unittest.TestCase):
    ...
    def test_base_locales_cover_runtime_regression_keys(self):
        required_keys = [
            ...
            "topbar.search_accessible_hint",
            "welcome.title",
            "welcome.body",
            "welcome.create_schedule",
            "panel.empty.add_schedule",
            "panel.empty.clear_search",
            "palette.accessible_search",
            "palette.accessible_results",
            "weather.desc.clear",
            "weather.desc.storm",
    ...
    def test_all_locales_include_recent_multilingual_regression_keys(self):
        required_keys = [
            ...
            "dialog.theme.preview.custom_style",
            ...
            "widget_mode.show_all",
            "menu.window_view_options",
            "menu.focus_view_options",
            "tray.view_options",
            "tray.focus_tools",
        ]
