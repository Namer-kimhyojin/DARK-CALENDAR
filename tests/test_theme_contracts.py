...
class ThemeContractTests(unittest.TestCase):
    ...
    def test_calendar_toolbar_and_detail_helpers_use_semantic_tokens(self):
        ...
        self.assertIn("QWidget#calendar_month_nav", bundle["nav_group"])
        self.assertIn("border-radius: 13px;", bundle["nav_group"])
        ...
        self.assertIn("min-width: 108px;", bundle["date_label"])
        self.assertIn("border-radius: 14px;", bundle["selection_label"])
        self.assertIn("border-radius: 6px;", bundle["more_btn"])
        self.assertIn("background: transparent;", bundle["nav_btn"])
        self.assertIn("background: transparent;", bundle["menu_btn"])
        self.assertIn("background: transparent;", bundle["icon_btn"])
        self.assertIn("background: transparent;", bundle["date_label"])
        self.assertIn("border: none;", bundle["nav_btn"])
